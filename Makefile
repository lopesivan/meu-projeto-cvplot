...
EXECUTABLE     := $(CONAN_BUILD_DIR)/bin/cvplot_demo
...
help:
	@echo "$(CYAN)╔════════════════════════════════════════════╗$(NC)"
	@echo "$(CYAN)║        CVPlot Demo - Build System        ║$(NC)"
	@echo "$(CYAN)╚════════════════════════════════════════════╝$(NC)"
	@echo ""
	...
	@echo "  $(GREEN)make run$(NC)       - Executa o demo (abre janela)"
...
init:
	@echo "$(BLUE)>>> 📦 Instalando CVPlot + OpenCV com Conan...$(NC)"
...
run:
	...
	@echo "$(CYAN)>>> 📊 Abrindo janela CVPlot (ESC para sair)$(NC)"
	$(EXECUTABLE)
